...
namespace GitUI
{
    public class FormGerritBase : GitExtensionsForm
    {
        ...
        private readonly TranslationString _selectChange = new TranslationString("There was a problem loading the .gitreview file. Please review your settings.");
        private readonly TranslationString _plinkRequired = new TranslationString("Ssh must be configured with PuTTY to be able to communicate to communicate with Gerrit.");
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (Settings == null)
            {
                MessageBox.Show(this, _selectChange.Text);
                Dispose();
                return;
            }
            ...
            if (!GitCommandHelpers.Plink())
            {
                MessageBox.Show(this, _plinkRequired.Text);
                Dispose();
                return;
            }
